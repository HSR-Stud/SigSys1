\section{Einheitssignale}
	...
	\begin{tabular}{ll} 
		\textbf{Sprungfunktion \skript{17}} &
...
\begin{tabular}{ll}	
		\textbf{Rampenfunktion \skript{18}} & \matlab{ramp}
		\\
		\parbox{6cm}{
		...
		\\ 
		\\ \hline & \\
		\textbf{Rechteckimpuls \skript{19}} & 
		\\
		\parbox{6cm}{
		...
		\\ \hline & \\
		\textbf{Impulsfunktion \skript{21}} &
	...
	\subsubsection{Signalmanipulationen}
		\begin{tabularx}{\textwidth}{|l|X|X|X|X|X|}
			...
			&	\multirow{2}{*}{\textbf{Strecken um Faktor $\mathbf{a}$}}
			&	\multirow{2}{*}{\textbf{Stauchen um Faktor $\mathbf{a}$}}
