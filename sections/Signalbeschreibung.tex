		...
		\rotatebox{-90}{
			\begin{minipage}[]{22.5cm}
				\begin{tabular}{|c|c|c|c|c|c|}
					...
					& & & & & 
					\\ 
					&	\input{tikz/rechtecksimpuls.tex}
					&	\input{tikz/dreiecksimpuls.tex}
					&	\input{tikz/saegezahnimpuls.tex}
					...
					&	\input{tikz/faltung_dreieck.tex}
					&	\input{tikz/faltung_gauss.tex}
					&	\input{tikz/faltung_halbgauss.tex}
					&	
					&	
					\\ \hline 
					\textbf{Dreieckimpuls}
