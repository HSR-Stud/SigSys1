...
\begin{tabular}{|l|l|l|}
	...
	\hline
	\parbox[c][4cm]{5.9cm}{\includegraphics[width=5.9cm]{./bilder/Signale/SinusAbklingend.png}} &
	\parbox[c][4cm]{5.9cm}{\includegraphics[width=5.9cm]{./bilder/Signale/Dreieck.png}} &
	\parbox[c][4cm]{5.9cm}{\includegraphics[width=5.9cm]{./bilder/Signale/Noise.png}} \\
	\hline
\end{tabular} \\
